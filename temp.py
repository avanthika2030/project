...
retained_customers = data[data['Purchase Count'] > 1]['Customer Reference ID'].nunique()
total_customers = data['Customer Reference ID'].nunique()
retention_rate = (retained_customers / total_customers) * 100

print(f"\nRetention Rate: {retention_rate:.2f}%")

# Calculate Best Engagement Time
...
total_customers = data['Customer Reference ID'].nunique()
churned_customers = data[data['Churn Risk'] == 1]['Customer Reference ID'].nunique()
...
print("Dataset saved to 'updated_dataset.csv'")
